...
Ten characters or more. Anything you will actually remember.
        </div>
        ...
        <form class="login_form">
          ...
          <div class="login_field">
            ...
            <input type="email" id="loginEmail" name="email" class="login_input" placeholder="Password address" required>
...
Password updated
               ...
               That is done. You can sign in with your new password now.
